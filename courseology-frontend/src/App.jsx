...
const App = () => {
  return (
    <Router>
      <Routes>
        <Route path="/our-courses" element={<Courses />}></Route>
        <Route path="/create-a-course" element={<CreateCourse />}></Route>
        <Route path="/add-a-teacher" element={<AddTeacher />}></Route>
        <Route path="/course/:courseId" element={<CourseInformation />}></Route>
        <Route
